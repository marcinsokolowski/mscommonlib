help("Sets up the paths you need to use mscommonlib")
local version = '1.0'
local build_options = 'default'
local tool = 'mscommonlib'
local root_dir = '/group/director2183/msok/software/centos7.6/development/mscommonlib'
